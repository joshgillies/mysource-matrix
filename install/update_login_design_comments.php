...
* +--------------------------------------------------------------------+
*
* $Id: update_login_design_comments.php,v 1.1.2.1 2011/04/27 00:29:34 ewang Exp $
*
*/

/**
* Update the parse file of all login designs. The squiz licence comment should be moved after the doctype.
* See bug #5038
*
* Usage:  php install/update_login_design_comments.php [PATH_TO_ROOT]
*
