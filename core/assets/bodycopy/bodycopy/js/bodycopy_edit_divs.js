...
function bodycopy_insert_div(bodycopy_name, divid, before) {
	...
	if (typeof bodycopy_available_templates !== 'undefined') {
		bodycopy_current_edit['available_templates'] = bodycopy_available_templates;
	}
	bodycopy_show_popup("insert_div.php", 325, 330);
...
function bodycopy_edit_div_properties(bodycopy_name, divid, can_delete) {
	...
	if (typeof bodycopy_applied_template !== 'undefined') {
		bodycopy_current_edit["applied_template"] = bodycopy_applied_template[divid];
	}
...
function bodycopy_edit_div_conditions(bodycopy_name, divid, parentid) {
	...
	bodycopy_show_popup("edit_div_conditions.php", 355, 480, divid, 'div');
