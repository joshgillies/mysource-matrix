...
* +--------------------------------------------------------------------+
*
* $Id: header.php,v 1.8.16.2 2011/02/21 05:03:45 ewang Exp $
*
*/
...
<table <?php echo htmlspecialchars($table_width); ?> <?php echo htmlspecialchars($table_height); ?> cellspacing="1" cellpadding="0" border="0" bgcolor="#402F48">
	<tr>
