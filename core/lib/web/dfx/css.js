...
{
    if (element) {
        dfxjQuery(element).css(property, value);
    }
...
{
    dfxjQuery(elements).css(property, value);
...
{
    return dfxjQuery(element).css(property);
...
{
    return dfxjQuery(element).hasClass(className);
...
{
    dfxjQuery(element).addClass(classNames);
...
{
    dfxjQuery(element).removeClass(classNames);
...
{
    dfxjQuery(elems).toggleClass(className);
