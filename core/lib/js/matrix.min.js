...
for(i=0;i<buttons.length;i++){newElt=document.createElement('INPUT');newElt.type=buttons[i].type;newElt.value=buttons[i].value;if(buttons[i].className){newElt.className=buttons[i].className+' disabled';}
