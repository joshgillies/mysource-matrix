...
* +--------------------------------------------------------------------+
*
* $Id: AssetManager.java,v 1.5.2.1 2004/11/21 23:22:38 mmcintyre Exp $
...
public class AssetManager implements ReloadAssetListener {
	...
	public void assetsReloaded(JsEvent e) {
		...
		try {
			...
			assetsReloaded((String) params.get("assetids"));
		} catch (Exception ioe) {
	...
	public void assetsReloaded(String assetidsStr) {
		String[] assetids
			= MatrixToolkit.split(assetidsStr, ",");
