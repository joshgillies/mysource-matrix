...
* +--------------------------------------------------------------------+
*
* $Id: AssetTypeFactory.java,v 1.1 2004/01/13 00:48:02 mmcintyre Exp $
...
public class AssetTypeFactory {
	...
	* 
	* @param assetTypesElement			the <code>&lt;asset_types&gt; ...&lt;/asset_types&gt;</code> element
	*
	...
	*/
	...
	/**
	* returns a URL for an icon based of a type code
	*
	* @param typeCode the typecode of the wanted Icon
	*
	* @return a url to the icon for the passed in type code
	*/
	public URL getIconURL(String typeCode) {
		URL iconURL =null;
		try {
	...
	* 
	* @param assetTypeElement	the <code>&lt;asset_type&gt; ...&lt;/asset_type&gt;</code> element
	*
	* @param parentMap			map for storing the typecode that this type inherits from for later resolution
	...
	*/
	private void processAssetTypeElement(Element assetTypeElement, Map parentMap) {
		...
		URL iconURL = getIconURL(typeCode);
	...
	* @throws AssetTypeNotFoundException	if the asset type for <code>typeCode</code> is not found
	*/
	...
	*
	* @return the string representation of the asset factory
	*/
