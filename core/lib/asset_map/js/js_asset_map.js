...
* +--------------------------------------------------------------------+
*
* $Id: js_asset_map.js,v 1.1.2.83 2013/07/22 03:41:28 lwright Exp $
*
*/
...
//--        DRAWING METHODS        --//
    ...
    this.drawTree = function(rootAsset, container, start, totalAssets) {
        console.info(['Draw Tree', start, totalAssets]);
        var assetLine = null;
        ...
        if ((totalAssets === -1) || (totalAssets > (start + rootAsset.asset.length))) {
