...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="Init();">
		...
		<fieldset id="cell_panel">
			<legend>Cell</legend>
			<div>
				<img title="Add ColSpan" alt="Add ColSpan" src="images/thr.gif" onclick="table.addColSpan();"/>
				<img alt="Delete ColSpan" title="Delete ColSpan" src="images/thl.gif" onclick="table.delColSpan();" />
				<img alt="Add RowSpan" title="Add RowSpan" src="images/tvd.gif" onclick="table.addRowSpan();"/>
				<img alt="Delete RowSpan" title="Delete RowSpan" src="images/tvu.gif" onclick="table.delRowSpan();" />
