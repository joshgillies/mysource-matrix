...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="Init();">
        ...
        <fieldset id="cell_panel">
            <legend>Cell</legend>
            <div>
                <img id="addcolspan" title="Add ColSpan" alt="Add ColSpan" src="i/thr.gif" onclick="table.addColSpan();"/>
                <img id="delcolspan" alt="Delete ColSpan" title="Delete ColSpan" src="i/thl.gif" onclick="table.delColSpan();"/>
                <img id="addrowspan" alt="Add RowSpan" title="Add RowSpan" src="i/tvd.gif" onclick="table.addRowSpan();"/>
                <img id="delrowspan" alt="Delete RowSpan" title="Delete RowSpan" src="i/tvu.gif" onclick="table.delRowSpan();"/>
                <img alt="divider" src="i/div.gif" />
                <img id="THead" alt="Head Cell" title="Head Cell" src="i/th.gif" onclick="table.th();" />
            </div>
