...
* +--------------------------------------------------------------------+
*
* $Id: edit_row.php,v 1.8.20.2 2011/02/15 06:15:27 cupreti Exp $
*
*/
...
<html style="width:380px; height:270px;">
	...
	<head>
		<title>Edit Row Properties</title>
		...
		<script type="text/javascript">
			...
			function onOK() {
				...
				__dlg_close("editRowProperties", params);
				return false;
			};

			function onCancel() {
				__dlg_close("editRowProperties", null);
				return false;
			};
	...
	<body onLoad="Init();">
		...
		<div class="title">Row Properties</div>
		...
		<form action="" method="get">
			<table width="100%">
				...
				<tr>
					<td width="100%">
						<fieldset>
						<legend><b>Row Styles / Colours</b></legend>
							<table width="100%">
								<tr>
